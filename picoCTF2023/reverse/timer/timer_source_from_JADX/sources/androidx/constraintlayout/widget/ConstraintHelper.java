...
public abstract class ConstraintHelper extends View {
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0015R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    ...
                    setIds(string);
                } else if (attr == C0015R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(java.lang.String r6) {
        ...
        L_0x0031:
            ...
            java.lang.Class<androidx.constraintlayout.widget.R$id> r2 = androidx.constraintlayout.widget.C0015R.C0018id.class
