...
public class ConstraintWidget {
    ...
    public String toString() {
        ...
        sb.append(str2);
        sb.append("(");
        sb.append(this.f93mX);
        sb.append(", ");
        sb.append(this.f94mY);
        sb.append(") - (");
    ...
    public int getX() {
        ...
        return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f93mX;
    }
    ...
    public int getY() {
        ...
        return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f94mY;
    }
    ...
    /* access modifiers changed from: protected */
    public int getRootX() {
        return this.f93mX + this.mOffsetX;
    }

    /* access modifiers changed from: protected */
    public int getRootY() {
        return this.f94mY + this.mOffsetY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int goneMargin) {
        switch (C02441.f95x6930e354[type.ordinal()]) {
            case 1:
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type anchorType) {
        switch (C02441.f95x6930e354[anchorType.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    private void applyConstraints(androidx.constraintlayout.core.LinearSystem r38, boolean r39, boolean r40, boolean r41, boolean r42, androidx.constraintlayout.core.SolverVariable r43, androidx.constraintlayout.core.SolverVariable r44, androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour r45, boolean r46, androidx.constraintlayout.core.widgets.ConstraintAnchor r47, androidx.constraintlayout.core.widgets.ConstraintAnchor r48, int r49, int r50, int r51, int r52, float r53, boolean r54, boolean r55, boolean r56, boolean r57, boolean r58, int r59, int r60, int r61, int r62, float r63, boolean r64) {
        ...
        L_0x0069:
            r14 = r59
        L_0x006b:
            int[] r17 = androidx.constraintlayout.core.widgets.ConstraintWidget.C02441.f96x6d00e4a2
            int r18 = r45.ordinal()
            r17 = r17[r18]
            switch(r17) {
    ...
    static /* synthetic */ class C02441 {
        ...
        static {
            ...
            try {
                f96x6d00e4a2[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f96x6d00e4a2[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f96x6d00e4a2[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f95x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f95x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f95x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f95x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f95x6930e354[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f95x6930e354[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f95x6930e354[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f95x6930e354[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    public void copy(ConstraintWidget src, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.f93mX = src.f93mX;
        this.f94mY = src.f94mY;
    ...
    public void getSceneString(StringBuilder ret) {
        ...
        ret.append("\n");
        ret.append("    actualLeft:" + this.f93mX);
        ret.append("\n");
        ret.append("    actualTop:" + this.f94mY);
        ret.append("\n");
