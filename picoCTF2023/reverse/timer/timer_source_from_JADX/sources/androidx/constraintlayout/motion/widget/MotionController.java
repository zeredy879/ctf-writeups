...
public class MotionController {
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f109x;
        start.top = this.mStartMotionPath.f110y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f109x;
        end.top = this.mEndMotionPath.f110y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f109x - this.mStartMotionPath.f109x;
        float dy = this.mEndMotionPath.f110y - this.mStartMotionPath.f110y;
        float startCenterX = this.mStartMotionPath.f109x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f110y + (this.mStartMotionPath.height / 2.0f);
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            c = 1;
            float float_l = this.mStartMotionPath.f109x + ((this.mEndMotionPath.f109x - this.mStartMotionPath.f109x) * position);
            float float_t = this.mStartMotionPath.f110y + ((this.mEndMotionPath.f110y - this.mStartMotionPath.f110y) * position);
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f109x - this.mStartMotionPath.f109x;
        float dTop = this.mEndMotionPath.f110y - this.mStartMotionPath.f110y;
