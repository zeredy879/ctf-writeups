...
public class PathInterpolatorCompat implements Interpolator {
    ...
    /* renamed from: mX */
    private float[] f152mX;

    /* renamed from: mY */
    private float[] f153mY;
    ...
    private void initPath(Path path) {
        ...
        if (numPoints > 0) {
            ...
            if (((double) Math.abs(this.f152mX[0])) > 1.0E-5d || ((double) Math.abs(this.f153mY[0])) > 1.0E-5d || ((double) Math.abs(this.f152mX[numPoints - 1] - 1.0f)) > 1.0E-5d || ((double) Math.abs(this.f153mY[numPoints - 1] - 1.0f)) > 1.0E-5d) {
                throw new IllegalArgumentException("The Path must start at (0,0) and end at (1,1) start: " + this.f152mX[0] + "," + this.f153mY[0] + " end:" + this.f152mX[numPoints - 1] + "," + this.f153mY[numPoints - 1]);
            }
            float prevX = 0.0f;
