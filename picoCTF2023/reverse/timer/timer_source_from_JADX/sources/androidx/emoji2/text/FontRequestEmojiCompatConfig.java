    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                if (this.mCallback != null) {
                    ...
                    this.mExecutor.execute(new C0380xc2d47b97(this));
                }
            }
        }
        ...
        private void scheduleRetry(Uri uri, long waitMs) {
            synchronized (this.mLock) {
                ...
                if (this.mObserver == null) {
                    C03791 r2 = new ContentObserver(handler) {
                ...
                if (this.mMainHandlerLoadCallback == null) {
                    this.mMainHandlerLoadCallback = new C0381xc2d47b98(this);
                }
        ...
        public void createMetadata() {
            ...
            L_0x0034:
                ...
                androidx.core.p003os.TraceCompat.beginSection(r2)     // Catch:{ all -> 0x0074 }
                ...
                androidx.core.p003os.TraceCompat.endSection()     // Catch:{ all -> 0x0095 }
                java.lang.Object r2 = r8.mLock     // Catch:{ all -> 0x0095 }
                monitor-enter(r2)     // Catch:{ all -> 0x0095 }
