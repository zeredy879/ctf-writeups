...
class AppCompatTextHelper {
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        this.mStyle = a.getInt(C0005R.styleable.TextAppearance_android_textStyle, this.mStyle);
        boolean z = false;
        if (Build.VERSION.SDK_INT >= 28) {
            int i = a.getInt(C0005R.styleable.TextAppearance_android_textFontWeight, -1);
            this.mFontWeight = i;
            if (i != -1) {
                this.mStyle = (this.mStyle & 2) | 0;
            }
        }
        if (a.hasValue(C0005R.styleable.TextAppearance_android_fontFamily) || a.hasValue(C0005R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            if (a.hasValue(C0005R.styleable.TextAppearance_fontFamily)) {
                fontFamilyId = C0005R.styleable.TextAppearance_fontFamily;
            } else {
                fontFamilyId = C0005R.styleable.TextAppearance_android_fontFamily;
            }
        ...
        } else if (a.hasValue(C0005R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            switch (a.getInt(C0005R.styleable.TextAppearance_android_typeface, 1)) {
                case 1:
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            if (a.hasValue(C0005R.styleable.TextAppearance_android_textColor) && (textColor = a.getColorStateList(C0005R.styleable.TextAppearance_android_textColor)) != null) {
                this.mView.setTextColor(textColor);
            }
            if (a.hasValue(C0005R.styleable.TextAppearance_android_textColorLink) && (textColorLink = a.getColorStateList(C0005R.styleable.TextAppearance_android_textColorLink)) != null) {
                this.mView.setLinkTextColor(textColorLink);
            }
            if (a.hasValue(C0005R.styleable.TextAppearance_android_textColorHint) && (textColorHint = a.getColorStateList(C0005R.styleable.TextAppearance_android_textColorHint)) != null) {
                this.mView.setHintTextColor(textColorHint);
            }
        }
