...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mIconifiedByDefaultId = propertyMapper.mapBoolean("iconifiedByDefault", C0005R.attr.iconifiedByDefault);
            this.mQueryHintId = propertyMapper.mapObject("queryHint", C0005R.attr.queryHint);
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        C02035 r8 = new View.OnClickListener() {
        ...
        C02057 r9 = new TextView.OnEditorActionListener() {
        ...
        TintTypedArray a2 = a;
        ViewCompat.saveAttributeDataForStyleable(this, context, C0005R.styleable.SearchView, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        LayoutInflater inflater = LayoutInflater.from(context);
        int layoutResId = a2.getResourceId(C0005R.styleable.SearchView_layout, C0005R.layout.abc_search_view);
        ...
        ViewCompat.setBackground(findViewById, a2.getDrawable(C0005R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, a2.getDrawable(C0005R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(a2.getDrawable(C0005R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(a2.getDrawable(C0005R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(a2.getDrawable(C0005R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(a2.getDrawable(C0005R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(a2.getDrawable(C0005R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a2.getDrawable(C0005R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0005R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a2.getResourceId(C0005R.styleable.SearchView_suggestionRowLayout, C0005R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a2.getResourceId(C0005R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a2.getBoolean(C0005R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a2.getDimensionPixelSize(C0005R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a2.getText(C0005R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a2.getText(C0005R.styleable.SearchView_queryHint);
        int imeOptions = a2.getInt(C0005R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a2.getInt(C0005R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a2.getBoolean(C0005R.styleable.SearchView_android_focusable, true));
        a2.recycle();
