...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<LinearLayoutCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mDividerId = propertyMapper.mapObject("divider", C0005R.attr.divider);
            this.mDividerPaddingId = propertyMapper.mapInt("dividerPadding", C0005R.attr.dividerPadding);
            this.mMeasureWithLargestChildId = propertyMapper.mapBoolean("measureWithLargestChild", C0005R.attr.measureWithLargestChild);
            this.mShowDividersId = propertyMapper.mapIntFlag("showDividers", C0005R.attr.showDividers, new IntFunction<Set<String>>() {
