...
import androidx.coordinatorlayout.C0020R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0020R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (defStyleAttr == 0) {
            a = context.obtainStyledAttributes(attrs, C0020R.styleable.CoordinatorLayout, 0, C0020R.style.Widget_Support_CoordinatorLayout);
        } else {
            a = context.obtainStyledAttributes(attrs, C0020R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            if (defStyleAttr == 0) {
                saveAttributeDataForStyleable(context, C0020R.styleable.CoordinatorLayout, attrs, a, 0, C0020R.style.Widget_Support_CoordinatorLayout);
            } else {
                saveAttributeDataForStyleable(context, C0020R.styleable.CoordinatorLayout, attrs, a, defStyleAttr, 0);
            }
        }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            boolean hasValue = a.hasValue(C0020R.styleable.CoordinatorLayout_Layout_layout_behavior);
