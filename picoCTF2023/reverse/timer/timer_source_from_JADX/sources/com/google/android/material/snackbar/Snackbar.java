...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0105R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0105R.attr.snackbarButtonStyle, C0105R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            ...
            if (hasSnackbarContentStyleAttrs(context)) {
                i = C0105R.layout.mtrl_layout_snackbar_include;
            } else {
                i = C0105R.layout.design_layout_snackbar_include;
            }
