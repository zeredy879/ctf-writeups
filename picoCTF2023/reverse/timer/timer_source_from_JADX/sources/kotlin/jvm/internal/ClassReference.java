...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (Object item$iv$iv : $this$mapIndexed$iv) {
            ...
            destination$iv$iv.add(TuplesKt.m48to((Class) item$iv$iv, Integer.valueOf(index$iv$iv)));
        ...
        for (String kotlinName : $this$associateTo$iv) {
            ...
            Pair pair = TuplesKt.m48to(sb2, kotlinName + ".Companion");
        ...
        for (Map.Entry next : FUNCTION_CLASSES.entrySet()) {
            ...
            $this$classFqNames_u24lambda_u2d4.put(name, "kotlin.Function" + arity);
        }
